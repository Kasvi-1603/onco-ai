...
import { startAnalyze, approveSession, createDemoSession } from "../../lib/api";
...
export default function PatientPortalLanding() {
  ...
  const [sessionId, setSessionId] = useState<string | null>(() => {
    ...
    return localStorage.getItem("active_patient_session_id");
  });
  ...
  useEffect(() => {
    ...
    if (urlSession) {
      ...
      queueMicrotask(() => setSessionId(urlSession));
    }
  }, [searchParams]);
